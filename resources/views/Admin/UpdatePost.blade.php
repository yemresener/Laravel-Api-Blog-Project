...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/UpdatePost.css') }}">
...
<body>
    ...
    <form class="form" action="" enctype="multipart/form-data" id="createPost">
        @csrf
        
        <label for="">Confirm</label>

        <select class="category_id" name="confirm" id="confirm">
        ...
        <select name="category_id" class="category_id" id="category_id">
        ...
        <p>
            ...
            <div class="MoreDiv" id="additional_content2" style="display: none;">
                ...
                <textarea name="low_article2" rows="5" cols="50" placeholder="Nullable" id="low_article2"></textarea><br><br>
        ...
        <button class="MoreBtn" type="submit">Send</button>
    </form>

    <label class="delete_label">Delete Post</label><p></p>
    <p id="message" style="color: green; font-size:20px;"></p>
    <form class="form" action=""enctype="multipart/form-data" id="deletePost" >
        @csrf
    ...
    <script src="{{ asset('js/API-UpdatePost.js') }}"></script>
